  ...
  <div class="mobile-menu-content">
    ...
    @auth
      <div class="mobile-user-info">
        ...
        <div>
          <div class="user-label">{{ auth()->user()->name }}</div>
          <div class="user-subtitle">Admin Utama</div>
        </div>
      </div>
    @else
    ...
    <section class="kepsek-section" id="info">
        ...
        <div class="kepsek-wrapper">
            <img src="{{ asset('shape-02.png') }}" alt="" class="shape-bg">
                <img src="{{ asset(isset($maskot) && $maskot->gambar_maskot ? 'storage/' . $maskot->gambar_maskot : 'assets-landing-page/kepsek.png') }}" alt="">
...
<section class="profile-section" id="profile">
  ...
  <div class="video-container">
    <div class="video-wrapper" id="videoWrapper">
      <!-- Thumbnail -->
      <img src="{{ asset(isset($profile) && $profile->banner_img ? 'storage/' . $profile->banner_img : 'assets-landing-page/t.png') }}" alt="Thumbnail" class="thumbnail">
